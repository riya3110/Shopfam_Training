...
import com.shopfam.security.oauth.CustomerOAuth2UserService;
import com.shopfam.security.oauth.OAuth2LoginSuccessHandler;
    ...
    public SecurityFilterChain FilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .logout(logout -> logout
                        .permitAll()).rememberMe(me -> me.key("1234567890_aBcDeFgHiJkLmNoPqRsTuVwXyZ").tokenValiditySeconds(14 * 24 * 60 * 60))
