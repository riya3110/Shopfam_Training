...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		//Setting siteName = new Setting("SITE_NAME" , "Shopfam" , SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO" , "Shopfam.png" , SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT" , "Copyright (C) 2021 Shopfam Ltd." , SettingCategory.GENERAL);
