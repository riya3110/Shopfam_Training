...
public class CountryRestControllerTests {
	...
	@Test
	@WithMockUser(username="RiyaSri@gmail.com" , password = "riya2020" , roles="ADMIN")
	public void testListCountries() throws Exception {
		String url = "/countries/list";
		MvcResult result = mockMvc.perform(get(url).with(csrf())).andExpect(status().isOk())
								.andDo(print())
								.andReturn();
	...
	@Test
	@WithMockUser(username = "RiyaSri@gmail.com", password = "something", roles = "ADMIN")
